...
export function ContactDetails(){
    return(
        <div className="w-full flex px-4 py-4 flex-col justify-center flex-shrink-0 flex-grow-1 md:w-1/2 lg:w-1/2 min-h-[30rem] lg:h-[33rem] gap-4">
            <h1 className="text-3xl dark:text-white text-blue-600 font-bold">Contact Us</h1>
            <p className="dark:text-slate-600 text-blue-600">Email, call,chat us or fill out the form to learn more about colour studios and how you can contribute in becoming a part of us.</p>
            <Link className="text-blue-600 flex gap-4 items-center" href="mailto:rogetzgamer@gmail.com" target="blank"><FaMailBulk className="text-3xl"/><span className="font-bold">e-mail us</span></Link>
            <Link className="text-blue-600 flex gap-4 items-center" href="https://wa.me/+254768230039" target="blank"><FaWhatsapp className="text-3xl"/><span className="font-bold">chat with us</span></Link>
            {/*enable chatting with AI assistance to enable quick responses.*/}
            <Link className="text-blue-600 flex gap-4 items-center" href="mailto:rogetzgamer@gmail.com" target="blank"><FaAndroid className="text-3xl"/><span className="font-bold">chat with AI assistance</span></Link>
            <Link className="text-blue-600 flex gap-4 items-center" href="tel:+254768230039" target="blank"><FaFax className="text-3xl"/><span className="font-bold">call us</span></Link>
            <div className="flex gap-4 flex-row flex-wrap w-full">
                <div className="w-[15rem] flex flex-col gap-2 h-auto">
                    ...
                    <p className="dark:text-slate-600 text-blue-600">Our activity team is up 24/7 to address any concerns concerning shoot events or aid in making shoot events successful. Call us,email us or chat with us anytime anyday</p>
                </div>
                <div className="w-[15rem] flex flex-col gap-2 h-auto">
                    <h2 className="font-bold tracking-widest">Feedback and suggestions</h2>
                    <p className="dark:text-slate-600 text-blue-600">We'd appreciate your feedback, that helps us improve our events. Your suggestions are always welcome.</p>
                </div>
            </div>
        </div>
    )
...
export function ContactCard(){
    return(
        <div className="w-full flex gap-4 px-8 md:px-1 py-4 lg:px-4 flex-col rounded-lg order-first md:order-last md:w-1/3 lg:w-1/3 flex-grow-1 flex-shrink-0 min-h-[30rem] bg-slate-900">
            <div>
                <h1 className="text-2xl text-blue-800 font-bold">Get in touch</h1>
            ...
            <button type="submit" className="text-white w-full h-12 rounded-3xl text-xl tracking-widest bg-blue-600">submit</button>
        </div>
    )
}
...
export function MapCard(){
    return(
        <div className="w-full px-4 md:px-0  md:5/6 lg:w-2/3 h-[36rem] flex flex-col gap-4 ">
            <h1 className="text-3xl text-center dark:text-white text-blue-600 font-bold">Locate Us</h1>
